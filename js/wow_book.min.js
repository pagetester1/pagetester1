...
window.Modernizr = (function(d, l, u) {
  ...
  var A = ["Webkit", "Moz", "O", "ms"],
    ...
    f = {}.hasOwnProperty,
    k;
  "undefined" === typeof f || "undefined" === typeof f.call
    ? (k = function(a, b) {
  ...
  (function(a, b) {
    ...
    e(
      ...
      function(a, b) {
        ...
        g.csstransforms3d =
          9 === (e.csstransforms3d && e.csstransforms3d.offsetLeft) &&
          3 === e.csstransforms3d.offsetHeight;
      },
      f,
      b
    );
  ...
  for (var h in n)
    k(n, h) &&
      ((b = h.toLowerCase()), (g[b] = n[h]()), a.push((g[b] ? "" : "no-") + b));
  z.cssText = "";
  return (
    (n = null),
    (g._version = "2.5.3"),
  ...
  s = (function() {
    function n() {
      var a = w(),
        e = k(b);
      a !== b
        ? (f((b = a), e), d(l).trigger(p))
        : e !== b && (location.href = location.href.replace(/#.*/, "") + e);
    ...
    d.browser.msie &&
      ...
      (function() {
        ...
        a.start = function() {
          b ||
            ((c = (c = d.fn[p].src) && c + w()),
            (b = d('<iframe tabindex="-1" title="empty"/>')
              .hide()
              .one("load", function() {
                c || f(w());
                n();
        ...
        f = function(a, c) {
          ...
          a !== c &&
            ((e.title = g.title),
            e.open(),
            f && e.write('<script>document.domain="' + f + '"\x3c/script>'),
            e.close(),
            (b.location.hash = a));
        };
      })();
...
(function(d) {
  function l(a, c) {
    ...
    f = this.pagesContainer = this.origin = d(
      "<div class='wowbook-origin'></div>"
    )
      .css({ position: "absolute" })
      .appendTo(a);
    b.bookShadow = d("<div class='wowbook-book-shadow'></div>")
      .appendTo(a)
    ...
    b.foldShadow = d("<div class='wowbook-shadow-fold'></div>").appendTo(
      b.shadowContainer
    );
    b.foldGradientContainer = d(
      "<div class='wowbook-fold-gradient-container'></div>"
    ).appendTo(b.shadowContainer);
    b.foldGradientElem = d(
      "<div class='wowbook-fold-gradient'></div>"
    ).appendTo(b.foldGradientContainer);
    b.hardPageShadow = d("<div class='wowbook-hard-page-shadow'></div>")
      .css({ display: "none" })
      .appendTo(f);
    !d.support.opacity &&
      d.wowBook.support.filters &&
      d.wowBook.applyAlphaImageLoader([
    ...
    this.leftHandle = d("<div class='wowbook-handle wowbook-left'></div>")
      .data("corner", "l")
      .appendTo(f);
    this.rightHandle = d("<div class='wowbook-handle wowbook-right'></div>")
      .data("corner", "r")
      .appendTo(f);
    Modernizr.csstransforms3d &&
      ((e = d("<div>").css("transform", "perspective(1px)")),
      (this.perspectiveUnit = "none" != e.css("transform") ? "px" : ""),
      (e = null));
    d.browser.msie &&
      d(".wowbook-handle", a).css({ backgroundColor: "#fff", opacity: "0.01" });
    d(".wowbook-handle", f).bind("mousedown.wowbook", function(a) {
      return b.pageEdgeDragStart(a);
    });
    c.curl &&
      d(".wowbook-handle", f).hover(
        function(a) {
          if (!b.curlTimer) {
    ...
    if (c.deepLinking && this.getLocationHash()) {
      ...
      "number" === typeof m &&
        ((b.startPage = m), w(b.elem) || b.elem[0].scrollIntoView());
    }
    this.flipSound && (this.audio = this.createAudioPlayer());
    if (this.opts.keyboardNavigation)
      d(document).on("keydown.wowbook", function(a) {
        d(a.target).filter("input, textarea, select").length ||
          (a.which === b.opts.keyboardNavigation.back && b.back(),
          a.which === b.opts.keyboardNavigation.advance && b.advance());
      });
    d(window).on("hashchange.wowbook", function() {
      var a = window.location.hash;
      if (a === b.locationHashSetTo) b.locationHashSetTo = void 0;
      else {
        var c = (a = "" === a && !b.locationEndsInHash())
          ? b.startPage
          : b.locationHashToPage();
        "number" === typeof c &&
          (b.gotoPage(c, !a), a || w(b.elem) || b.elem[0].scrollIntoView());
      }
    });
    c.forceBasicPage &&
    ...
    this.mouseWheel &&
      a.mousewheel(function(a, c) {
        if (b.mouseWheel)
          return (
            "zoom" === b.mouseWheel
              ? (0 < c && b.zoomIn(), 0 > c && b.zoomOut(), b.zoomedAt(a))
              : (0 < c && b.advance(), 0 > c && b.back()),
            !1
          );
      });
    ...
    if (!d.wowBook.support.boxSizing) {
      ...
      e =
        "none" == a.css("borderTopStyle")
          ? 0
          : s[(m = a.css("borderTopWidth"))] || parseFloat(m);
      f =
        "none" == a.css("borderRightStyle")
          ? 0
          : s[(m = a.css("borderRightWidth"))] || parseFloat(m);
      k =
        "none" == a.css("borderBottomStyle")
          ? 0
          : s[(m = a.css("borderBottomWidth"))] || parseFloat(m);
      h =
        "none" == a.css("borderLeftStyle")
          ? 0
          : s[(m = a.css("borderLeftWidth"))] || parseFloat(m);
      f =
  ...
  l.prototype = {
    ...
    setDimensions: function(a, c) {
      ...
      for (var h = 0, m = this.pages.length; h < m; h++)
        this.pages[h].css({
      ...
      this.opts.gutterShadow &&
        d(".wowbook-gutter-shadow", b).css("height", this.pageHeight);
      ...
      this.opts.handleWidth &&
        d(".wowbook-handle", k).css("width", this.opts.handleWidth);
      ...
      this.clipBoundaries &&
        ...
        (k = [this.pageHeight - k, b.width(), k, 0]),
        this.origin.css("top", -k[0]),
        d(".wowbook-inner-clipper", b).css({
          width: "100%",
          height: k[2] - k[0],
          top: k[0],
        }),
    ...
    scale: function(a) {
      if (d.wowBook.support.transform) {
        ...
        this.opts.zoomUsingTransform
          ? c.css({ transform: "scale(" + a + ")", transformOrigin: "0 0" })
          : c.css("zoom", a);
        this.elem.css({
    ...
    insertPage: function(a, c) {
      if (this.isDoublePage(a)) this.insertDoublePage(a, c);
        ...
        var b = d("<div class='wowbook-page'></div>")
          .css({
            width: this.pageWidth,
            height: this.pageHeight,
            display: "none",
          ...
          .append(a);
        d.wowBook.support.boxSizing &&
          a.css(d.wowBook.support.boxSizing, "border-box");
        p(a, this.pageWidth, this.pageHeight);
        b.hardPageSetByUser = a.hasClass("wowbook-hardpage");
        this.opts.gutterShadow &&
          d("<div class='wowbook-gutter-shadow'></div>")
            .appendTo(a)
    ...
    insertDoublePage: function(a, c) {
      if (!this._insertingDoublePage) {
        ...
        f.css(d.wowBook.support.boxSizing + "", "border-box").wrap(
          "<div class='wowbook-double-page'></div>"
        );
        this.insertPage(b.parent(), !0);
        this.insertPage(e.parent(), !0);
        d.wowBook.support.boxSizing ||
          (p(b, 2 * this.pageWidth, this.pageHeight),
          p(e, 2 * this.pageWidth, this.pageHeight));
        c || this.updateBook();
    ...
    updateBook: function(a) {
      ...
      for (var c = this.rtl, b, e = 0, f = this.pages.length; e < f; e++) {
        b = this.pages[e]
          .toggleClass("wowbook-left", c)
          .toggleClass("wowbook-right", !c)
          .data({ pageIndex: e, holded: !1 });
        b.pageIndex = e;
        var k = d(".wowbook-page-content", b);
        b.src = this.replaceNumberHolder(k.data("src") || this.opts.srcs, e);
        b.image = this.replaceNumberHolder(
    ...
    doPageNumbering: function() {
      ...
      if (a.pageNumbers) {
        ...
        for (var f = this.opts.firstPageNumber, b = 0; b < e; b++)
          d(".wowbook-page-number", this.pages[b]).remove();
        for (b = c + 1; b < a; b++)
          d(".wowbook-page-number", this.pages[b]).remove();
        for (b = e; b <= c; b++)
          (a = d(".wowbook-page-number", this.pages[b])),
            a.length ||
              ((a = d(".wowbook-page-content", this.pages[b])),
              (a = d('<div class="wowbook-page-number"></div>').appendTo(a))),
            a.html(f++);
      }
    },
    findPagesType: function() {
      ...
      if (!d)
        for (
          a.hardcovers &&
            (f.push(0, 1, -1),
            this.pageIsOnTheLeft(this.pages.length - 1) && f.push(-2)),
            a = 0,
            e = f.length;
          a < e;
          a++
      ...
      for (a = this.pages.length; a--; )
        (f = d || c[a] || this.pages[a].hardPageSetByUser),
    ...
    showPage: function(a, c) {
      ...
      for (var t = 0; t <= v; t++)
        (p = this.pages[t].onLeft != this.rtl ? t : v - t),
          (g = this.transparentPages
            ? m
              ? t <= b
                ? "block"
                : "none"
      ...
      (b = this.onShowPage) &&
        d.isFunction(b) &&
        !this.isOnPage(a) &&
        (b(this, this.pages[a], a),
        (e = this.otherPage(a)) && b(this, this.pages[e], e));
      this.currentPage = a;
      this.centeredWhenClosed &&
        ((b = !!this.leftPage(a)),
        (e = this.rightPage(a)),
        this.origin.css("left", b && e ? 0 : b ? h / 2 : -h / 2));
      this.positionBookShadow();
      !1 !== c &&
        this.opts.updateBrowserURL &&
        this.locationHashToPage() != a &&
        (this.locationHashSetTo = window.location.hash = this.pageToLocationHash(
          a
        ));
      this.showThumbnail();
    },
    holdPage: function(a, c, b, e, f) {
      ...
      if (a) {
        ...
        if (!e) e = this.pageIsOnTheLeft(d) ? "l" : "r";
          ...
          !this.corners[e] ||
          (this.pageIsOnTheLeft(d) ? /r/ : /l/).test(e)
        )
          return;
        ...
        if (f) {
          ...
          "basic" == this.pageType(f)
            ? this.foldPageBasic(a, c, b, e, f)
            : a.isHardPage || f.isHardPage
            ? this.holdHardpage(a, c, b, e, f)
            : this.foldPage(a, c, b, e, f);
          if (
            !a.data("holded") &&
            (a.addClass("wowbook-page-holded"),
            f.addClass("wowbook-page-holded"),
            a.data("holded", !0),
            (this.holdedPage = a),
            (this.holdedPageBack = f),
            ...
            this.opts.onHoldPage(this, d, a, f);
        }
      }
    },
    foldPage: function(a, c, b, e, f) {
      this._currentFlip ||
        (this._currentFlip = this.foldPageStart(a, c, b, e, f));
      this._currentFlip.page == a &&
        ((this._currentFlip.x = c),
        (this._currentFlip.y = b),
        this._currentFlip.page.data("holdedAt", { x: c, y: b }),
        (this._currentFlip.corner = e),
    ...
    foldPageStyles: function(a) {
      ...
      a.pageContent.css(
        "transform",
        k(-l, 0) + " rotate(" + (-q).toFixed(7) + "deg)"
      );
      a.page.css(
        "transform",
        k((Math.cos(v) * l).toFixed(5), (Math.sin(v) * l).toFixed(5)) +
          " rotate(" +
          q.toFixed(7) +
          "deg)"
      );
      ...
      if (this.shadows && 0 < s) {
        ...
        this.internalShadow.css({
          ...
          transformOrigin:
            e - l + "px " + (f + (a.shadowHeight - b) / 2) + "px",
        });
        l -= a.foldShadowWidth;
        this.foldShadow.css({
          transform: k(l + h, w) + " rotate(" + q + "deg)",
      ...
      a.back.css(
        "transform",
        k(
          (g + h + Math.cos(v) * l).toFixed(5),
          (t - b + Math.sin(v) * l).toFixed(5)
        ) +
          " rotate(" +
          q +
          "deg)"
      ...
      this.foldGradient && 0 < s
        ? (this.foldGradientContainer.css({
            opacity: s,
            display: "block",
            transform:
              k(c - g - a.foldGradientWidth / 2, t - a.foldGradientHeight / 2) +
              " rotate(" +
              -q +
              "deg)",
          }),
    ...
    holdHardpage: function(a, c, b, e, d) {
      this._currentFlip ||
        (this._currentFlip = this.flipHardPageStart(a, c, b, e, d));
      this._currentFlip.page == a &&
        ((this._currentFlip.x = c),
        (this._currentFlip.y = b),
        this._currentFlip.page.data("holdedAt", { x: c, y: b }),
    ...
    flipHardPageStart: function(a, c, b, e, d) {
      ...
      if (d && d.length) {
        ...
        this.opts.use3d &&
          ...
          d.css(Modernizr.prefixed("perspectiveOrigin"), "0 50%"));
    ...
    flipHardPageStyles: function(a) {
      ...
      if (this.opts.use3d && Modernizr.csstransforms3d) {
        var g;
        g = c
          ? -this._calculateAngleFromX(-b, f)
          : this._calculateAngleFromX(b, f);
        this.animating &&
          ((m = this._animationData),
          this.curledPage || m.curled
            ? ((m.curled = !0),
              m.angle ||
                ((h = { from: g, to: 0 }),
                (m.angle = h),
                (g = b + m.dx),
                (h.to = c
                  ? -this._calculateAngleFromX(-g, f)
                  : this._calculateAngleFromX(g, f)),
                Math.abs(b) == f && (h.from = 0),
                Math.abs(g) == f && (h.to = 0),
                (h.delta = h.to - h.from)),
              (g = m.angle.from - (m.angle.delta * (m.from.x - x)) / m.dx))
            : (Math.abs(x - m.from.x), Math.abs(m.dx / 2)));
        a.css({
          transform:
            "perspective(" +
      ...
      !d.wowBook.support.transform &&
        d.wowBook.support.filters &&
        ((e = "M11=" + e + ", M12=0, M21=" + Math.tan(h) * e + ", M22=1"),
        a.css(
          "filter",
    ...
    _calculateAngleFromX: function(a, c, b) {
      ...
      var k = a * a;
      a = Math.acos(
        (c * b * a - Math.sqrt(d * d * b * k + d * d * k * k - d * b * k * k)) /
          (d * b + d * k)
      );
      return (a = -a * e);
    },
    foldPageBasic: function(a, c, b, e, d) {
      this._currentFlip ||
        (this._currentFlip = this.foldPageBasicStart(a, c, b, e, d));
      this._currentFlip &&
        this._currentFlip.page == a &&
        ((this._currentFlip.x = c),
        (this._currentFlip.y = b),
    ...
    foldPageBasicStart: function(a, c, b, e, d) {
      ...
      if (d && d.length) {
        ...
        this.foldShadow
          .css({ display: "none", height: h, transform: "", top: 0 })
    ...
    foldPageBasicStyles: function(a) {
      ...
      var h = k / 2,
        ...
        g;
      f
        ? ((m = "rect(-1000px 1000px 1000px " + h + "px)"),
          (g = "rect(-1000px 1000px 1000px " + (d - h) + "px)"),
          (k -= d))
        : ((m = "rect(-1000px " + (d - h) + "px 1000px -1000px)"),
          (g = "rect(-1000px " + h + "px 1000px -1000px)"),
          (k = d - k + d));
      c.css("clip", m);
      b.css({ clip: g, left: k, display: "block" });
      c = this.calculateOpacity(2 * h, 2 * d, this.shadowThreshold, 50);
      this.shadows && 0 < c
        ? ((b = f ? h - a.foldShadowWidth : d - h + d),
          this.shadowContainer.css("opacity", c),
      ...
      this.foldGradient && 0 < c
        ? ((b = f ? d - h : h - a.foldGradientWidth),
          this.foldGradientContainer.css({
            opacity: c,
            left: b,
            display: "block",
    ...
    rafCallback: function() {
      ...
      if (this.currentFlip && !this.currentFlip.finished) {
        ...
        1 <= c && (c = 1);
        a.x =
          a.initialX + a.deltaX * a.easing(c, a.duration * c, 0, 1, a.duration);
        a.y =
          a.initialY + a.deltaY * a.easing(c, a.duration * c, 0, 1, a.duration);
        a.arc &&
          (a.y -=
            ((0.5 - Math.abs(0.5 - a.easing(c, a.duration * c, 0, 1))) *
              this.pageHeight) /
            10);
        a.dragging &&
    ...
    releasePage: function(a, c, b, d) {
      ...
      if (c && k)
        ...
        ((c = a.data("pageIndex")),
        void 0 === b && (b = this.holdedPageBack || this.backPage(c)),
        ...
        this.resetPage(a),
        b && b.length && (this.resetPage(b), b.hide()),
        this.foldShadow
        ...
        this.opts.onReleasePage(this, c, a, b);
    },
    ...
    gotoPage: function(a, c) {
      ...
      if (
        ...
        if (h) {
          ...
          var m, g;
          b
            ? ((m = this.leftPage(a)), (g = this.rightPage(a)))
            : ((m = this.rightPage(a)), (g = this.leftPage(a)));
          var p = g && g.is(":visible");
          if (f)
            for (f = h.pageIndex - 1; 0 <= f; f--)
              this.pages[f].css("display", "none");
          else
            for (f = h.pageIndex + 1, d = this.pages.length; f < d; f++)
              this.pages[f].css("display", "none");
          ...
          b
            ? ((p = p || { x: 0, y: 0 }),
              (b = 2 * k.pageWidth),
              (d = "bl" != f ? 0 : this.pageHeight))
            : ((p = p || { x: this.pageWidth, y: 0 }),
              (b = -k.pageWidth),
              (d = "br" != f ? 0 : this.pageHeight));
          var n = "linear";
          if (this.centeredWhenClosed && (h.isHardPage || g.isHardPage)) {
            ...
            this.currentPage == (r ? 0 : q) &&
              ((b += this.pageWidth / 2),
              r ? a == q && this.pageIsOnTheLeft(a) : 0 == a) &&
              (b += this.pageWidth / 2);
            this.currentPage == (r ? q : 0) &&
              ((b -= this.pageWidth / 2),
              a == (r ? 0 : q) && (b -= this.pageWidth / 2));
          }
          k.flip({
            from: [p.x, p.y],
            to: [b, d],
    ...
    advanceAfterTimeout: function(a) {
      ...
      this.slideShowTimer = setTimeout(function() {
        c.animating || c.holdedPage
          ? c.advanceAfterTimeout(100)
          : (c.advance(),
            c.isOnPage(c.pages.length - 1)
              ? c.stopSlideShow()
              : c.advanceAfterTimeout(c.slideShowDelay + c.turnPageDuration));
      }, a);
    },
    ...
    findSections: function(a) {
      ...
      "string" === typeof c &&
        ((b = c),
        (c = []),
        d(b, this.elem).each(function(a, b) {
    ...
    pageToSection: function(a) {
      for (
        var c = this.sections, b, d = 0, f = c.length;
        d < f && !(c[d].page > a);
        d++
      )
        b = c[d];
    ...
    fillToc: function(a, c) {
      ...
      if (0 !== b.length) {
        ...
        c ||
          ((k = b.is("UL, OL") ? "<li>" : "<div>"),
          (c = '<a href="${link}">${section}</a>'));
        for (var h = 0, g = e.length; h < g; h++)
          (f = e[h]),
            (f = c
              .replace(/\$\{link\}/g, "#" + this.id + "/" + f.id.substr(1))
              .replace(/\$\{section\}/g, f.title)
              .replace(/\$\{page\}/g, f.page)),
            d(f)
              .appendTo(b)
              .wrap(k);
      }
    ...
    zoom: function(a) {
      for (var c = 0, b = this.pages.length; c < b; c++)
        if (this.pages[c].data("holdedAt")) return;
      ...
      if (a !== this.zoomLevel) {
        ...
        g.right < r.right &&
          b.css(
            "marginLeft",
            (parseFloat(b.css("marginLeft")) || 0) + (r.right - g.right)
          );
        g.top > r.top && b.css("marginTop", 0);
        g.bottom < r.bottom &&
          b.css(
            "marginTop",
            (parseFloat(b.css("marginTop")) || 0) + (r.bottom - g.bottom)
          );
        ...
        1 === this.zoomLevel
          ? (c
              .unbind("mousemove.wowbook")
              .css({ overflow: "visible", left: 0, top: 0 }),
            this.clipBoundaries && this.clipper.css("overflow", "hidden"),
            b.css({ marginLeft: 0, marginTop: 0 }))
          : (this.clipBoundaries && this.clipper.css("overflow", "visible"),
            c.css("overflow", "hidden"),
            this.zoomed ||
              c.bind("mousemove.wowbook", function(a) {
                e.zoomedAt(a);
              }));
        this.zoomed = 1 !== a;
        this.positionBookShadow();
    ...
    setupFullscreen: function() {
      if (A) {
        ...
        c = "fullscreenchange mozfullscreenchange webkitfullscreenchange MSFullscreenChange ".replace(
          / /g,
          ".wowbook "
        );
        ...
        this._fullscreenErrorHandler = function() {
          a.opts.onFullscreenError &&
            a.opts.onFullscreenError.apply(this, arguments);
        };
    ...
    positionBookShadow: function() {
      ...
      if (c) {
        ...
        liftingLastPageOnRight =
          !!b && b.onLeft && b.pageIndex == (this.rtl ? 0 : a - 1);
        noPageOnLeft = !this.leftPage() || d;
        noPageOnRight = !this.rightPage() || liftingLastPageOnRight;
        onePageVisible = noPageOnLeft != noPageOnRight;
        noPageOnLeft && noPageOnRight
          ? this.bookShadow.hide()
          : ((a = this.opts.zoomUsingTransform ? this.currentScale : 1),
            this.bookShadow.css({
              left:
                (noPageOnLeft ? c : 0) +
                this.pagesContainer.position().left / a,
    ...
    touchSupport: function() {
      ...
      d(document).on("touchmove.wowbook", function(c) {
        if (a._touchStarted) {
          ...
          20 < Math.abs(a._touchEnded.x - a._touchStarted.x) &&
            c.preventDefault();
          c.preventDefault();
        }
      });
      d(document).on("touchend.wowbook touchcancel.wowbook", function(c) {
        if (a._touchStarted) {
          !a._touchEnded &&
            d(c.target).hasClass("wowbook-handle") &&
            ((c = d(c.target).data("corner")),
            "r" === c && a.advance(),
            "l" === c && a.back());
          ...
          if (!(20 > Math.abs(c) || 200 < b) && Math.abs(c) > Math.abs(f))
            return 0 > c ? a.advance() : a.back(), !1;
        }
      });
    },
    pageEdgeDragStart: function(a) {
      if (
        ...
        this.zoomed ||
        !d(a.target).hasClass("wowbook-handle")
      )
        return !1;
      var c = this,
        b = c.elem.offset();
      ...
      this.opts.zoomUsingTransform &&
        ((c.pageGrabbedOffset.left /= this.currentScale),
        (c.pageGrabbedOffset.top /= this.currentScale));
    ...
    pageEdgeDrag: function(a) {
      ...
      this.stopAnimation(!1);
      this.flip(c, a, this.pageGrabbed, { corner: b, dragging: !0 });
      return !1;
    },
      ...
      if (!this.curledPage && !this.holdedPage) {
        ...
        if (a && !a.isCurled) {
          ...
          this.flip({
            from: [d, f],
            to: [
              d + this.opts.curlSize * (b ? 1 : -1),
              f + this.opts.curlSize * (c ? -1 : 1),
            ],
            corner: (c ? "b" : "t") + (b ? "l" : "r"),
            page: a,
            duration: 400,
    ...
    uncurl: function(a, c) {
      if (this.curledPage) {
        ...
        a.isCurled &&
          (this.stopAnimation(!1),
          this.releasePage(a, !c, void 0, 400),
          (a.isCurled = !1),
    ...
    initThumbnails: function() {
      var a = this.opts;
      this.thumbnails = [];
      var c = (this.thumbnailsContainer = d("<div class='wowbook-thumbnails'>")
        .append(
          "<div class='wowbook-wrapper'><div class='wowbook-back wowbook-button' /><div class='wowbook-clipper'><ul></ul></div><div class='wowbook-next wowbook-button' /></div>"
        )
        .css("display", "none")
        .css("transform", "translateZ(0)")
        .appendTo(d(a.thumbnailsParent)));
    ...
    createThumbnails: function() {
      ...
      var a,
        c = this.thumbnailConfig();
      this.thumbnails = [];
      for (var b = 0, d = this.pages.length; b < d; b++)
        (a = this.createThumbnail(b, c)),
          this.thumbnailsList.append(a),
          this.thumbnails.push(a);
      if (this.rtl)
        for (
          a = this.thumbnailsList.children(),
            a
              .eq(0)
              .addClass("wowbook-right")
              .removeClass("wowbook-left"),
            b = 1,
            d = a.length;
          b < d;
          b += 2
        )
          a.eq(b).insertAfter(a.eq(b + 1));
    ...
    thumbnailConfig: function() {
      var a = {},
        ...
        f =
          e / this.pageWidth || b / this.pageHeight || this.opts.thumbnailScale;
      c.remove();
    ...
    createThumbnail: function(a, c) {
      ...
      if (b) {
        ...
        var e = d('<li class="wowbook-thumbnail"><div class="wowbook-overlay">')
        ...
        this.opts.thumbnailsSprite
          ...
          : ((b = b.clone()),
            b.hasClass("wowbook-page-holded") &&
              (this.resetPage(b),
              b.find(".wowbook-fold-gradient-container").remove()),
            b.css(c.cloneCSS),
            e.prepend(b));
        var f = this;
        e.click(function() {
    ...
    _setThumbnailsListPosition: function(a, c) {
      ...
      f[b ? "top" : "left"] = a;
      this.thumbnailsList.animate(
        f,
        void 0 != c ? c : this.opts.thumbnailsAnimOptions
      );
    },
    ...
    toggleThumbnails: function(a) {
      d(this.thumbnailsContainer).is(":visible")
  ...
  var g = d.browser.msie && 9 > d.browser.version ? 1 : 0,
    s = { thin: 2 - g, medium: 4 - g, thick: 6 - g },
    n = window.document,
    z = n.documentElement,
    A =
      z.requestFullscreen ||
  ...
  d.wowBook.utils = {
    translate: function(a, c, b) {
      return d.wowBook.useTranslate3d
        ? "translate3d(" + a + "px, " + c + "px, " + (b || 0) + "px) "
        : "translate(" + a + "px, " + c + "px) ";
    },
    isMobile: function() {
...
(function(d) {
  ...
  if (d.event.fixHooks)
    for (var w = u.length; w; ) d.event.fixHooks[u[--w]] = d.event.mouseHooks;
  d.event.special.mousewheel = {
    setup: function() {
      if (this.addEventListener)
        for (var d = u.length; d; ) this.addEventListener(u[--d], l, !1);
      else this.onmousewheel = l;
    },
    teardown: function() {
      if (this.removeEventListener)
        for (var d = u.length; d; ) this.removeEventListener(u[--d], l, !1);
...
(function(d) {
  function l(l) {
    ...
    for (
      var g = w.length, s, n = l.charAt(0).toUpperCase() + l.substr(1);
      g--;

    )
      if (((s = w[g] + n), s in u.style)) return (d.wowBook.support[l] = s);
  }
  if (d.cssHooks) {
    ...
    d.wowBook.support.boxSizing &&
      ...
      (d.wowBook.support.boxSizing = !1);
    u = null;
    d.each(["transform", "transformOrigin"], function(l, g) {
      d.wowBook.support[g] &&
        d.wowBook.support[g] !== g &&
        !d.cssHooks[g] &&
        (d.cssHooks[g] = {
          get: function(l, n, p) {
    ...
    d.wowBook.applyAlphaImageLoader = function(l) {
      ...
      s = 0;
      for (n = l.length; s < n; s++)
        if (
          ((u = l[s]),
          B.addClass(u),
          (g = B.css("background-image").match(/^url\("(.*)"\)$/)))
        )
          (w +=
            "." +
            u +
